 ...
 */
class Boost_Biz_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__( '--None--', 'boost-biz') );
			?>
 ...
 * @see WP_Customize_Control
 */
class Boost_Biz_Dropdown_Category_Control extends WP_Customize_Control {
...
class Boost_Biz_Note_Control extends WP_Customize_Control {
...
class Boost_Biz_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Boost_Biz_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="boost-biz-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
...
class Boost_Biz_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="boost-biz-chosen-select" <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Boost_Biz_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Boost_Biz_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="boost-biz-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="boost-biz-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_html( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu boost-biz-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="boost-biz-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Boost_Biz_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="boost-biz-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'boost-biz' ); ?>" class="boost-biz-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Boost_Biz_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Boost_Biz_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
