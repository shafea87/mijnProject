...
if ( ! function_exists( 'boost_biz_sanitize_select' ) ) :
	/**
	 ...
	 */
	function boost_biz_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'boost_biz_sanitize_image' ) ) :
	/**
	 ...
	 */
	function boost_biz_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'boost_biz_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function boost_biz_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'boost_biz_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Boost Biz 1.0.0
	*/
	function boost_biz_sanitize_page( $input ) {
...
if ( ! function_exists( 'boost_biz_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Boost Biz 1.0.0
	 ...
	 */
	function boost_biz_sanitize_checkbox( $checked ) {
...
if( ! function_exists( 'boost_biz_sanitize_single_category' ) ) :
	/**
	 ...
	 */
	function boost_biz_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'boost_biz_sanitize_category_list' ) ) :
	/**
	 ...
	 */
	function boost_biz_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'boost_biz_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function boost_biz_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function boost_biz_sanitize_switch_control( $input ) {
...
* @since Boost Biz 1.0.0
*/
function boost_biz_sanitize_links( $input ) {
...
if ( ! function_exists( 'boost_biz_sanitize_sortable' ) ) :
	/**
	...
	* @since Boost Biz 1.0.0
	*/
	function boost_biz_sanitize_sortable( $input ) {
