...
class Boost_Biz_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'boost_biz';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'boost-biz' ), $i ),
...
// Initialize.
$boost_biz_footer_widgets = new Boost_Biz_Footer_Widgets();
